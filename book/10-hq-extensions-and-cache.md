...
A search index stores a prepared representation of content so queries can find matches quickly without walking the published tree every time. That is the same distinction explained in [Chapter 14](./14-examine-indexes-and-cache-adjacent-querying.md): a cache remembers an answer; an index helps find answers.
...
- [Chapter 9: Cache busting and invalidation](./09-cache-busting-and-invalidation.md) — the refresher and `DistributedCache` mechanics Deploy batches on top of.
...
- [Chapter 14: Examine, indexes, and cache-adjacent querying](./14-examine-indexes-and-cache-adjacent-querying.md) — why Search belongs near caching without being the same thing.
- [Chapter 12: Small local cache example with tags](./12-small-local-cache-example-with-tags.md) — the tag-and-evict pattern to use for cacheable catalogue pages.
...
[^05-forms]: See [U18 in the appendix](./17-appendix-sources.md#u18-umbraco-forms-docs) and [U3](./17-appendix-sources.md#u3-website-output-caching).
[^05-engage]: See [U19 in the appendix](./17-appendix-sources.md#u19-umbraco-engage-docs) and [U3](./17-appendix-sources.md#u3-website-output-caching).
[^05-commerce]: See [U20 in the appendix](./17-appendix-sources.md#u20-umbraco-commerce-docs), [U3](./17-appendix-sources.md#u3-website-output-caching), and [U6](./17-appendix-sources.md#u6-server-side-extensions-cache-docs).
[^05-suppress]: See [U12 in the appendix](./17-appendix-sources.md#u12-deploy-settings).
[^05-search]: See [U21](./17-appendix-sources.md#u21-umbraco-search-overview), [U22](./17-appendix-sources.md#u22-umbraco-search-installation), and [S2](./17-appendix-sources.md#s2-umbracocmssearch-repository) in the appendix.
[^05-search-cache]: See [U24](./17-appendix-sources.md#u24-umbraco-search-reindexing-content), [U25](./17-appendix-sources.md#u25-umbraco-search-indexing-notification-handling), and [S2](./17-appendix-sources.md#s2-umbracocmssearch-repository). The CMS source trees supplied for this book do not include the separate Search implementation.
[^05-search-docs]: See [U23 in the appendix](./17-appendix-sources.md#u23-umbraco-search-database-cache-for-index-values). Implementation details need the separate [S2](./17-appendix-sources.md#s2-umbracocmssearch-repository) source tree to verify locally.
[^05-search-shadow]: See [S2](./17-appendix-sources.md#s2-umbracocmssearch-repository), especially the Examine provider source; this is package-source evidence rather than CMS-source evidence in the local checkouts.
[^05-search-db-cache]: See [U23 in the appendix](./17-appendix-sources.md#u23-umbraco-search-database-cache-for-index-values).
[^05-search-reindex]: See [U24 in the appendix](./17-appendix-sources.md#u24-umbraco-search-reindexing-content).
[^05-search-notifications]: See [U25 in the appendix](./17-appendix-sources.md#u25-umbraco-search-indexing-notification-handling).
