...
- [Chapter 6 - Published Cache and Load Balancing](./06-published-cache-and-load-balancing.md) for the runtime behaviour behind these types.
- [Chapter 9 - Cache Busting and Invalidation](./09-cache-busting-and-invalidation.md) for refresher flow and change types.
- [Chapter 7 - How the Hybrid Cache Engine Works](./07-hybrid-cache-engine.md) for deeper internals and design direction.
...
[^15-appcache]: See [C9 in the appendix](./17-appendix-sources.md#c9-iappcache-interface-path-v17).
[^15-appcaches]: See [C10 in the appendix](./17-appendix-sources.md#c10-appcaches-implementation-path-v17).
[^15-refresher]: See [C11 in the appendix](./17-appendix-sources.md#c11-icacherefresher-interface-path-v17).
[^15-distributed]: See [C12 in the appendix](./17-appendix-sources.md#c12-distributedcache-implementation-path-v17).
[^15-docsvc]: See [C13 in the appendix](./17-appendix-sources.md#c13-documentcacheservice-path-v17-hybridcache).
