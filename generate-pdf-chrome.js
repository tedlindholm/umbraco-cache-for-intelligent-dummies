...
const chapters = [
  ...
  '05-edge-cache-in-front-of-the-cda.md',
  '06-published-cache-and-load-balancing.md',
  '07-hybrid-cache-engine.md',
  '08-nucache-vs-hybrid-cache.md',
  '09-cache-busting-and-invalidation.md',
  '10-hq-extensions-and-cache.md',
  '11-cache-settings-talks-and-field-notes.md',
  '12-small-local-cache-example-with-tags.md',
  '13-storage-providers-and-media-caching.md',
  '14-examine-indexes-and-cache-adjacent-querying.md',
  '15-lessons-from-the-issue-tracker.md',
  '16-reading-the-cache-code.md',
  '17-appendix-sources.md',
  '18-appendix-umbfyi-archive-notes.md',
  '19-appendix-glossary.md',
